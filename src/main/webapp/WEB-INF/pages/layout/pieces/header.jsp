...
<link href="<c:url value="/resources/css/searchFilter.css"/>" rel="stylesheet" type="text/css" />
<link href="<c:url value="/resources/css/ui.multiselect.css"/>" rel="stylesheet" type="text/css" />
