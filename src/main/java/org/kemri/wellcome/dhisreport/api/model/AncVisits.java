...
public class AncVisits implements Serializable {
    ...
    @Column(name = "id")
    private Integer id;
    @Column(name = "Indicator ID")
    private Integer indicatorID;
    @Column(name = "Period ID")
    private Integer periodID;
    @Column(name = "Organisation unit ID")
    private Integer organisationunitID;
    @Column(name = "Indicator UID")
    private String indicatorUID;
    @Column(name = "Period UID")
    private Integer periodUID;
    @Column(name = "Organisation unit UID")
    private String organisationunitUID;
    @Column(name = "Indicator")
    private String indicator;
    @Column(name = "Period")
    private String period;
    @Column(name = "Organisation unit")
    private String organisationunit;
    @Column(name = "Indicator code")
    private String indicatorcode;
    @Column(name = "Period code")
    private Integer periodcode;
    @Column(name = "Organisation unit code")
    private String organisationunitcode;
    @Column(name = "Reporting month")
    private String reportingmonth;
    @Column(name = "Organisation unit parameter")
    private String organisationunitparameter;
    @Column(name = "Organisation unit is parent")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AncVisits)) {
            return false;
        }
        AncVisits other = (AncVisits) object;
    ...
    public String toString() {
        return "javaapplication1.AncVisits[ id=" + id + " ]";
    }
